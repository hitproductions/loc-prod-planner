...
function setupProjectsTab_() {
  ...
  var widths = [210, 104, 92, 96, 92, 62, 62, 108, 108, 62, 62, 62, 150, 100, 300, 220, 92];
  ...
  [P_COL.MUSIC, P_COL.SPECIAL].forEach(function (c) {
...
function refreshEngineerDropdowns() {
  ...
  if (sh) {
    ...
    [P_COL.REC_PICK, P_COL.ED_PICK, P_COL.MIX_PICK].forEach(function (c) {
